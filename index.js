...
let products = [
  {
    ...
    tags: "Women",
    description:
      "Can used it when you travel, it is waterproof and made up with PVC material"
  },
  {
...
function cleareverything() {
  let productloader_container = document.getElementById("productloader");
  if (productloader_container.innerHTML != "") {
    productloader_container.innerHTML = " ";
  }
}
//sort by tags function
function sort(category) {
  let arr = products.filter((product) => product.tags === category);
  insertitems(arr);
}
function showBag(category) {
  cleareverything();
...
//   document
//     .getElementById("bag-store-title")
